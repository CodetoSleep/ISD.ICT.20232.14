...
//        addMenuItem(2, "CD", splitMenuBtnSearch);
        ...
        sortCategoryAdd("Book", sortButton);
        sortCategoryAdd("DVD", sortButton);
        sortCategoryAdd("CD", sortButton);
    ...
    public void setImage(){
        ...
        File file2 = new File(Configs.IMAGE_PATH + "/" + "cart2.png");
...
//    }
    ...
    private void sortCategoryAdd(String text, ChoiceBox<String> choiceBox) {
        choiceBox.getItems().add(text);
        choiceBox.setOnAction(e -> {
            ...
            homeItems.forEach(me -> {
                MediaHandler media = (MediaHandler) me;
                if (media.getMedia().getTitle().toLowerCase().startsWith(choiceBox.getValue().toLowerCase())) {
                    filteredItems.add(media);
                }
            });
